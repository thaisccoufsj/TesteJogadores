(function ($, moment) {
    ...
    $.fn[pluginName] = function (options, p) {
        this.each(function () {
            if (!$.data(this, pluginDataName)) {
                ...
                if (
                    typeof $.data(this, pluginDataName)[options] === "function"
                ) {
    ...
    Plugin.prototype = {
                ...
                if (
                    ...
                    if (
                        ...
                        if (typeof this.params.currentDate === "string") {
                            ...
                            if (
                                typeof this.params.currentDate.isValid ===
                                    "undefined" ||
                                typeof this.params.currentDate.isValid !==
                                    "function"
                            ) {
                                var x = this.params.currentDate.getTime();
                                this.currentDate = moment(x, "x").locale(
                                    this.params.lang
                                );
                            } else {
                        ...
                        this.$element.val(
                            this.currentDate.format(this.params.format)
                        );
            ...
            for (var i = 0; i < 12; i++) {
                ...
                var fill =
                    this.currentDate.format(hFormat) == i
                        ...
                        : "transparent";
                var color =
                    this.currentDate.format(hFormat) == i ? "#fff" : "#000";
        ...
        initMinutes: function () {
            ...
            for (var i = 0; i < 60; i++) {
                if (i % 5 === 0) {
                    ...
                    var color =
                        this.currentDate.format("m") == i ? "#fff" : "#000";
            ...
            for (var i = 0; i < calendar.days.length; i++) {
                ...
                if (calendar.days[i] != 0) {
                    if (
                        ...
                        this.params.disabledDays.indexOf(
                            calendar.days[i].isoWeekday()
                        ) !== -1
                    ) {
                        _template +=
        ...
        _onSelectDate: function (e) {
            ...
            if (
                this.params.switchOnClick === true &&
